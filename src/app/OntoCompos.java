...
/**
 *Онтологическое отношение Композиции
 * @author 655
 * 24/07/2016
 */
public class OntoCompos extends MyOnto{
    MyEll ellKlass;
    MyEll ellElem;
    public OntoCompos(MyEll ellKlass, MyEll ellElem, String priznak, String url, String shape){
